...
public class RequestBuilder<TranscodeType> implements Cloneable,
   ...
   * {@link Image}) must be able to scale the thumbnail appropriately. See
   *
  ...
  @CheckResult
  @Override
  public RequestBuilder<TranscodeType> load(@Nullable PixelMap bitmap) {
   ...
   * avoided when possible. Prefer {@link #load(ohos.utils.net.Uri)} or {@link #load(String)}.
   */
  @Deprecated
  @CheckResult
  @Override
  ...
  /**
   * Sets the {@link Image} the resource will be loaded into, cancels any existing loads into
   ...
   * @return The
   * {@link Target} used to wrap the given {@link Image}.
   */
  public ViewTarget<Image, TranscodeType> into(Image view) {
    Util.assertMainThread();
  ...
  public FutureTarget<TranscodeType> submit(int width, int height) {
    ...
    if (Util.isOnBackgroundThread()) {
      glideContext.getMainHandler().postTask(new Runnable() {
        @Override
        public void run() {
