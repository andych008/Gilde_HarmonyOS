...
public abstract class AssetPathFetcher<T> implements DataFetcher<T> {
  ...
  public AssetPathFetcher(ResourceManager assetManager, String assetPath) {
  ...
  /**
   * Opens the given asset path with the given {@link ohos.global.resource.ResourceManager} and returns
   * the concrete data type returned by the ResourceManager.
   *
   * @param assetManager An ResourceManager to use to open the given path.
   * @param path         A string path pointing to a resource in assets to open.
   */
  protected abstract T loadResource(ResourceManager assetManager, String path) throws IOException;
