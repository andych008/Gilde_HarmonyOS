...
public final class GlideException extends Exception {
   ...
   *
   * <p>Causes may or may not be {@link com.bumptech.glide.load.engine.GlideException GlideExceptions}. Causes may also not be root
  ...
  private void addRootCauses(Throwable throwable, List<Throwable> rootCauses) {
    if (throwable instanceof com.bumptech.glide.load.engine.GlideException) {
      com.bumptech.glide.load.engine.GlideException glideException = (com.bumptech.glide.load.engine.GlideException) throwable;
  ...
  private static void appendCausesWrapped(List<Throwable> causes, Appendable appendable)
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (cause instanceof com.bumptech.glide.load.engine.GlideException) {
        com.bumptech.glide.load.engine.GlideException glideCause = (com.bumptech.glide.load.engine.GlideException) cause;
