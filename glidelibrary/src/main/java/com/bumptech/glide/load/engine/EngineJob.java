...
class EngineJob<R> implements com.bumptech.glide.load.engine.DecodeJob.Callback<R>,
  ...
  public void start(com.bumptech.glide.load.engine.DecodeJob<R> decodeJob) {
  ...
  @Override
  public void reschedule(com.bumptech.glide.load.engine.DecodeJob<?> job) {
  ...
  static class EngineResourceFactory {
    public <R> com.bumptech.glide.load.engine.EngineResource<R> build(Resource<R> resource, boolean isMemoryCacheable) {
      return new com.bumptech.glide.load.engine.EngineResource<>(resource, isMemoryCacheable, /*isRecyclable=*/ true);
    }
  }
