...
public class DiskLruCacheWrapper implements DiskCache {
  ...
  private static com.bumptech.glide.load.engine.cache.DiskLruCacheWrapper wrapper = null;
  ...
  public static synchronized DiskCache get(File directory, long maxSize) {
    ...
    if (wrapper == null) {
      wrapper = new com.bumptech.glide.load.engine.cache.DiskLruCacheWrapper(directory, maxSize);
    }
    return wrapper;
  }
  ...
  public static DiskCache create(File directory, long maxSize) {
    return new com.bumptech.glide.load.engine.cache.DiskLruCacheWrapper(directory, maxSize);
  }
