...
public class ByteArrayLoader<Data> implements ModelLoader<byte[], Data> {
  ...
  public static class ByteBufferFactory implements ModelLoaderFactory<byte[], ByteBuffer> {
    ...
    public ModelLoader<byte[], ByteBuffer> build(MultiModelLoaderFactory multiFactory) {
      return new com.bumptech.glide.load.model.ByteArrayLoader<>(new Converter<ByteBuffer>() {
        @Override
  ...
  /**
   * Factory for {@link com.bumptech.glide.load.model.ByteArrayLoader} and {@link InputStream}.
   */
  public static class StreamFactory implements ModelLoaderFactory<byte[], InputStream> {

    @Override
    public ModelLoader<byte[], InputStream> build(MultiModelLoaderFactory multiFactory) {
      return new com.bumptech.glide.load.model.ByteArrayLoader<>(new Converter<InputStream>() {
        @Override
