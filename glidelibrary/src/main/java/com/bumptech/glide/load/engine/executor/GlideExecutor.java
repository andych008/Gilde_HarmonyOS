...
public final class GlideExecutor implements ExecutorService {
  ...
  public static com.bumptech.glide.load.engine.executor.GlideExecutor newDiskCacheExecutor(
    ...
    return new com.bumptech.glide.load.engine.executor.GlideExecutor(
  ...
  public static com.bumptech.glide.load.engine.executor.GlideExecutor newUnlimitedSourceExecutor() {
    return new com.bumptech.glide.load.engine.executor.GlideExecutor(new ThreadPoolExecutor(
        0,
        Integer.MAX_VALUE,
        KEEP_ALIVE_TIME_MS,
        TimeUnit.MILLISECONDS,
  ...
  public static int calculateBestThreadCount() {
    if (bestThreadCount == 0) {
      bestThreadCount =
          Math.min(MAXIMUM_AUTOMATIC_THREAD_COUNT, com.bumptech.glide.load.engine.executor.RuntimeCompat.availableProcessors());
    }
