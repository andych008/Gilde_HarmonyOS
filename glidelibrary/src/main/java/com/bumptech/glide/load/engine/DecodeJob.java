...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback,
  ...
  private final Pools.Pool<com.bumptech.glide.load.engine.DecodeJob<?>> pool;
  @SuppressWarnings("WeakerAccess")
  @Synthetic
  ...
  DecodeJob(DiskCacheProvider diskCacheProvider, Pools.Pool<com.bumptech.glide.load.engine.DecodeJob<?>> pool) {
    this.diskCacheProvider = diskCacheProvider;
    this.pool = pool;
  }

  com.bumptech.glide.load.engine.DecodeJob<R> init(
  ...
  @Override
  public int compareTo(@NonNull com.bumptech.glide.load.engine.DecodeJob<?> other) {
  ...
  private DataFetcherGenerator getNextGenerator() {
    switch (stage) {
      ...
      case DATA_CACHE:
        return new com.bumptech.glide.load.engine.DataCacheGenerator(decodeHelper, this);
      case SOURCE:
        return new com.bumptech.glide.load.engine.SourceGenerator(decodeHelper, this);
      case FINISHED:
        return null;
      default:
  ...
  private void notifyEncodeAndRelease(Resource<R> resource, DataSource dataSource) {
    ...
    com.bumptech.glide.load.engine.LockedResource<R> lockedResource = null;
    if (deferredEncodeManager.hasResourceToEncode()) {
      lockedResource = com.bumptech.glide.load.engine.LockedResource.obtain(resource);
  ...
  private final class DecodeCallback<Z> implements DecodePath.DecodeCallback<Z> {
    ...
    public Resource<Z> onResourceDecoded(Resource<Z> decoded) {
      ...
      if (diskCacheStrategy.isResourceCacheable(isFromAlternateCacheKey, dataSource,
        ...
        com.bumptech.glide.load.engine.LockedResource<Z> lockedResult = com.bumptech.glide.load.engine.LockedResource.obtain(transformed);
  ...
  private static class DeferredEncodeManager<Z> {
    ...
    @SuppressWarnings("unchecked")
    <X> void init(Key key, ResourceEncoder<X> encoder, com.bumptech.glide.load.engine.LockedResource<X> toEncode) {
      this.key = key;
      this.encoder = (ResourceEncoder<Z>) encoder;
      this.toEncode = (com.bumptech.glide.load.engine.LockedResource<Z>) toEncode;
    }
  ...
  interface Callback<R> {
    ...
    void reschedule(com.bumptech.glide.load.engine.DecodeJob<?> job);
  }
