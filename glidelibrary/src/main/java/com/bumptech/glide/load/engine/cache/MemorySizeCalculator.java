...
public final class MemorySizeCalculator {
  ...
  MemorySizeCalculator(com.bumptech.glide.load.engine.cache.MemorySizeCalculator.Builder builder) {
    ...
    int maxSize =
        getMaxSize(builder.context, builder.lowMemoryMaxSizeMultiplier);
  ...
  private static int getMaxSize(Context context, float maxSizeMultiplier) {
    return Math.round(context.getAbilityManager().getAppLargeMemory() * maxSizeMultiplier);
  }
