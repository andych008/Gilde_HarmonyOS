...
final class DataCacheKey implements Key {
  ...
  public boolean equals(Object o) {
    if (o instanceof com.bumptech.glide.load.engine.DataCacheKey) {
      com.bumptech.glide.load.engine.DataCacheKey other = (com.bumptech.glide.load.engine.DataCacheKey) o;
