...
public abstract class DiskCacheStrategy {
   ...
   * {@link #RESOURCE} only.
   */
  public static final com.bumptech.glide.load.engine.DiskCacheStrategy ALL = new com.bumptech.glide.load.engine.DiskCacheStrategy() {
    @Override
   ...
   */
  public static final com.bumptech.glide.load.engine.DiskCacheStrategy NONE = new com.bumptech.glide.load.engine.DiskCacheStrategy() {
    @Override
    public boolean isDataCacheable(DataSource dataSource) {
      return false;
    }
   ...
   */
  public static final com.bumptech.glide.load.engine.DiskCacheStrategy DATA = new com.bumptech.glide.load.engine.DiskCacheStrategy() {
    @Override
    public boolean isDataCacheable(DataSource dataSource) {
   ...
   */
  public static final com.bumptech.glide.load.engine.DiskCacheStrategy RESOURCE = new com.bumptech.glide.load.engine.DiskCacheStrategy() {
    @Override
    public boolean isDataCacheable(DataSource dataSource) {
      return false;
    }
   ...
   */
  public static final com.bumptech.glide.load.engine.DiskCacheStrategy AUTOMATIC = new com.bumptech.glide.load.engine.DiskCacheStrategy() {
    @Override
    public boolean isDataCacheable(DataSource dataSource) {
      return dataSource == DataSource.REMOTE;
    }
