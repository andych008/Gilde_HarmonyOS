...
/**
 * Options for setting the value of {@link ohos.media.image.PixelMap#getConfig()} for
 * {@link ohos.media.image.PixelMap}s returned by {@link com.bumptech.glide.load.ResourceDecoder}s.
 *
...
public enum DecodeFormat {
   ...
   * should return {@link ohos.media.image.common.PixelFormat#ARGB_8888} for
   * {@link ohos.media.image.PixelMap#getConfig()} when possible.
   *
   * <p>On Android O+, this format will will use ARGB_8888 only when it's not possible to use
   * {@link ohos.media.image.common.PixelFormat#HARDWARE}.
   *
   * <p> GIF images decoded by {@link android.graphics.BitmapFactory} currently use an internal
   * hidden format that is returned as null from {@link ohos.media.image.PixelMap#getConfig()}. Since
   ...
   * ohos.media.image.common.PixelFormat#HARDWARE} on Android O+.
   *
   ...
   * should return {@link ohos.media.image.common.PixelFormat#ARGB_8888} for
   * {@link ohos.media.image.PixelMap#getConfig()}. Bitmaps decoded from formats that don't support or
   * use alpha should return {@link ohos.media.image.common.PixelFormat#RGB_565} for
   * {@link ohos.media.image.PixelMap#getConfig()}.
   *
   * <p>On Android O+, this format will will use ARGB_8888 only when it's not possible to use
   * {@link ohos.media.image.common.PixelFormat#HARDWARE}.
   */
