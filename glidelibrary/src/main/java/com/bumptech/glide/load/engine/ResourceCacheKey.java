...
final class ResourceCacheKey implements Key {
  ...
  public boolean equals(Object o) {
    if (o instanceof com.bumptech.glide.load.engine.ResourceCacheKey) {
      com.bumptech.glide.load.engine.ResourceCacheKey other = (com.bumptech.glide.load.engine.ResourceCacheKey) o;
