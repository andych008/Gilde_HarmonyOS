...
/**
 * Decodes {@link ohos.media.image.PixelMap Bitmaps} from {@link InputStream InputStreams}.
 */
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, PixelMap> {
  ...
  @Override
  public Resource<PixelMap> decode(InputStream source, int width, int height, Options options)
      throws IOException {
