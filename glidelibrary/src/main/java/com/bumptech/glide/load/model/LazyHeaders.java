...
public final class LazyHeaders implements Headers {
  ...
  private Map<String, String> generateHeaders() {
    ...
    for (Map.Entry<String, List<LazyHeaderFactory>> entry : headers.entrySet()) {
      ...
      for (int i = 0; i < size; i++) {
        ...
        if (!TextTool.isNullOrEmpty(header)) {
          sb.append(header);
      ...
      if (!TextTool.isNullOrEmpty(values)) {
  ...
  public boolean equals(Object o) {
    if (o instanceof com.bumptech.glide.load.model.LazyHeaders) {
      com.bumptech.glide.load.model.LazyHeaders other = (com.bumptech.glide.load.model.LazyHeaders) o;
  ...
  public static final class Builder {
    ...
    static {
      Map<String, List<LazyHeaderFactory>> temp
          = new HashMap<>(2);
      if (!TextTool.isNullOrEmpty(DEFAULT_USER_AGENT)) {
    ...
    /**
     * Returns a new immutable {@link com.bumptech.glide.load.model.LazyHeaders} object.
     */
    public com.bumptech.glide.load.model.LazyHeaders build() {
      copyOnModify = true;
      return new com.bumptech.glide.load.model.LazyHeaders(headers);
    }
    ...
    static String getSanitizedUserAgent() {
      ...
      if (TextTool.isNullOrEmpty(defaultUserAgent)) {
