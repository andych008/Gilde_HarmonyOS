...
/**
 * A {@link TransitionFactory} for complex types that have a {@link ohos.media.image.PixelMap} inside.
 ...
 *
 * @param <R> The type of the composite object that contains the {@link ohos.media.image.PixelMap} to
 *            be transitioned.
 */
