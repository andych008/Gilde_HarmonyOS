...
public interface Transition<R> {
  ...
  interface ViewAdapter {
     ...
     */
    void setDrawable(PixelMap drawable);
  }
   ...
   * @param adapter The {@link com.bumptech.glide.request.transition.Transition.ViewAdapter} wrapping a view that can at least return an
   *                @link android.view.View} from {@link com.bumptech.glide.request.transition.Transition.ViewAdapter#getView()}.
