...
public class ThumbnailRequestCoordinator implements RequestCoordinator,
  ...
  public boolean isEquivalentTo(Request o) {
    if (o instanceof com.bumptech.glide.request.ThumbnailRequestCoordinator) {
      com.bumptech.glide.request.ThumbnailRequestCoordinator that = (com.bumptech.glide.request.ThumbnailRequestCoordinator) o;
