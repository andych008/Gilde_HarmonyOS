...
public class NoTransition<R> implements Transition<R> {
  @Synthetic static final com.bumptech.glide.request.transition.NoTransition<?> NO_ANIMATION = new com.bumptech.glide.request.transition.NoTransition<>();
  @SuppressWarnings("rawtypes")
  private static final TransitionFactory<?> NO_ANIMATION_FACTORY = new NoAnimationFactory();

  /**
   * A factory that always returns the same {@link com.bumptech.glide.request.transition.NoTransition}.
   *
   * @param <R> the resource type that will be transitioned into a
   * {@link com.bumptech.glide.request.target.Target}.
   */
  ...
  /**
   * Returns an instance of a factory that produces {@link com.bumptech.glide.request.transition.NoTransition}s.
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Returns an instance of {@link com.bumptech.glide.request.transition.NoTransition}.
   */
  @SuppressWarnings("unchecked")
