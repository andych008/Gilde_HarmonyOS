...
public class ViewPropertyTransition<R> implements Transition<R> {
  ...
  /**
   * Constructor for a view property animation that takes an {@link com.bumptech.glide.request.transition.ViewPropertyTransition.Animator}
  ...
  /**
   * Always applies the {@link com.bumptech.glide.request.transition.ViewPropertyTransition.Animator} given in the constructor to the
