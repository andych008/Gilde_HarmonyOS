...
public class RequestFutureTarget<R> implements FutureTarget<R>,
   ...
   */
  public RequestFutureTarget(EventHandler mainHandler, int width, int height) {
    this(mainHandler, width, height, true, DEFAULT_WAITER);
  }

  RequestFutureTarget(EventHandler mainHandler, int width, int height, boolean assertBackgroundThread,
      Waiter waiter) {
  ...
  @Override
  public void onLoadStarted(int placeholder) {
