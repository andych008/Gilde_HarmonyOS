...
public class DrawableCrossFadeFactory implements TransitionFactory<Drawable> {
  ...
  /**
   * A Builder for {@link com.bumptech.glide.request.transition.DrawableCrossFadeFactory}.
   */
  ...
  public static class Builder {
    ...
    public com.bumptech.glide.request.transition.DrawableCrossFadeFactory build() {
      return new com.bumptech.glide.request.transition.DrawableCrossFadeFactory(durationMillis, isCrossFadeEnabled);
    }
  }
}
