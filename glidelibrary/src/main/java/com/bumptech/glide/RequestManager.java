...
public class RequestManager implements LifecycleListener,
    ModelTypes<RequestBuilder<PixelMap>> {
  private static final RequestOptions DECODE_TYPE_BITMAP = decodeTypeOf(PixelMap.class).lock();
  ...
  RequestManager(
    ...
    if (Util.isOnBackgroundThread()) {
      mainHandler.postTask(addSelfToLifecycle);
    } else {
  ...
  public void onDestroy() {
    ...
    mainHandler.removeTask(addSelfToLifecycle);
    glide.unregisterRequestManager(this);
  }

  /**
   * Attempts to always load the resource using any registered {@link
   * com.bumptech.glide.load.ResourceDecoder}s that can decode any subclass of {@link PixelMap}.
   * @return A new request builder for loading a {@link PixelMap}.
   */
  @CheckResult
  public RequestBuilder<PixelMap> asDrawable() {
    return as(PixelMap.class);
  }
  ...
  @CheckResult
  @Override
  public RequestBuilder<PixelMap> load(@Nullable PixelMap bitmap) {
    return asDrawable();
  }
  ...
  @CheckResult
  @Override
  public RequestBuilder<PixelMap> load(@Nullable String string) {
  ...
  @CheckResult
  @Override
  public RequestBuilder<PixelMap> load(@Nullable Uri uri) {
  ...
  @CheckResult
  @Override
  public RequestBuilder<PixelMap> load(@Nullable File file) {
  ...
  @Override
  @Deprecated
  public RequestBuilder<PixelMap> load(@Nullable URL url) {
  ...
  @CheckResult
  @Override
  public RequestBuilder<PixelMap> load(@Nullable byte[] model) {
  ...
  @CheckResult
  @Override
  public RequestBuilder<PixelMap> load(@Nullable Object model) {
    return asDrawable().load(model);
  }
  ...
  private static class ClearTarget extends ViewTarget<Component, Object> {

    ClearTarget(Component view) {
      super(view);
    }
