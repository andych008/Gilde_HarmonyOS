...
public class ExceptionCatchingInputStream extends InputStream {
  ...
  private static final Queue<com.bumptech.glide.util.ExceptionCatchingInputStream> QUEUE = Util.createQueue(0);

  private InputStream wrapped;
  private IOException exception;

  public static com.bumptech.glide.util.ExceptionCatchingInputStream obtain(InputStream toWrap) {
    com.bumptech.glide.util.ExceptionCatchingInputStream result;
    synchronized (QUEUE) {
      result = QUEUE.poll();
    }
    if (result == null) {
      result = new com.bumptech.glide.util.ExceptionCatchingInputStream();
    }
